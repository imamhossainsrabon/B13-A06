...
const Banner = () => {
    return (
        <div className='px-4  max-w-[1200px] mx-auto py-15 flex flex-col md:flex-row justify-center items-center gap-16'>
            <div className='max-w-[640px] space-y-4'>
                <div className='bg-[#E1E7FF] rounded-full flex justify-center items-center w-max py-2 px-4 mx-auto md:mx-0'>
                    ...
                    <h2 className='text-[#101727] md:text-[72px] text-[55px]  font-extrabold tracking-normal leading-[120%]  text-center md:text-left '>Supercharge Your Digital Workflow</h2>
